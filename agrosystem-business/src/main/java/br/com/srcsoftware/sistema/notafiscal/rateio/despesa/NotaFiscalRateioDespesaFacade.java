...
import br.com.srcsoftware.modular.financeiro.contapagar.ContaPagarFacade;
...
public final class NotaFiscalRateioDespesaFacade extends ContaPagarFacade implements NotaFiscalRateioDespesaServiceInterface{

	private final NotaFiscalRateioDespesaServiceImpl service;

	private NotaFiscalRateioDespesaFacade(){
		this.service = new NotaFiscalRateioDespesaServiceImpl();
	}

	public static NotaFiscalRateioDespesaFacade getInstance() {
		return new NotaFiscalRateioDespesaFacade();
	}

...
public final class ManutencaoImovelForm extends AbstractCRUDForm{

	private static final long serialVersionUID = 1342719712529624093L;

	private ManutencaoDTO manutencaoImovel;
	...
	public ManutencaoDTO getManutencaoImovel() {
		if ( this.manutencaoImovel == null ) {
			this.manutencaoImovel = new ManutencaoDTO();
		}
		return this.manutencaoImovel;
	}

	public void setManutencaoImovel( ManutencaoDTO manutencaoImovel ) {
		this.manutencaoImovel = manutencaoImovel;
	}

	@Override
	public void limparCamposCadastro( HttpServletRequest request ) {
		setManutencaoImovel( null );
	}

...
public final class ItemVeiculoForm extends AbstractCRUDForm{

	private static final long serialVersionUID = 1342719712529624093L;

	private ItemDTO itemVeiculo;
	...
	public ItemDTO getItemVeiculo() {
		if ( itemVeiculo == null ) {
			itemVeiculo = new ItemDTO();
		}
		return itemVeiculo;
	}

	public void setItemVeiculo( ItemDTO itemVeiculo ) {

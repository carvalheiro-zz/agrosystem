...
public final class ItemImplementoForm extends AbstractCRUDForm{

	private static final long serialVersionUID = 1342719712529624093L;

	private ItemDTO itemImplemento;
	...
	public ItemDTO getItemImplemento() {
		if ( itemImplemento == null ) {
			itemImplemento = new ItemDTO();
		}
		return itemImplemento;
	}

	public void setItemImplemento( ItemDTO itemImplemento ) {
		this.itemImplemento = itemImplemento;
	}

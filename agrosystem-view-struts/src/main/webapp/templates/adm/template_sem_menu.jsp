...
<body>
	...
	<div id="wrapper" style="background: rgba(255, 255, 255, 0.6);">
		<!-- Navigation -->
		<nav class="navbar navbar-default navbar-static-top cor-sistema" style="color: white; margin-bottom: 0px;" role="navigation">

			<div class="navbar-header" style="width: 100%">

				<!-- HEADER (MENU QUANDO PEQUENO + NOME DO SISTEMA) -->
		...
		<div id="page-wrapper" style="background: rgba(255, 255, 255, 0.0); margin: 0 !important;">
		...
		<html:messages id="message" message="false">
			...
			<script type="text/javascript">
				BootstrapDialog.show({
					...
					title : 'Atenção...',
					message : "<bean:write filter='false' name='message'/>",
					closable : false,

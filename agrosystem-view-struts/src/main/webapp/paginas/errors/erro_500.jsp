	...
	<div class="container">
		<div class="row">
			<div class="col-xs-offset-0 col-sm-offset-2 col-md-offset-3 col-lg-offset-3 col-xs-12 col-sm-8 col-md-6 col-lg-6">
				<div class="login-panel panel panel-default" style="border-radius: 3px; box-shadow: 0 6px 6px rgba(0, 0, 0, 0.3); background: rgba(255, 255, 255, 0.7); padding: 30px 40px 30px 40px; border: none; text-align: center; margin-top: 100px;">
					<div class="panel-body">

						<fieldset>
							<div class="row">
								<div class="col-xs-12">
									<img alt="Logo" title="Logo src" src="${contextPath}/assets/images/propria/server_error.png" style="margin-bottom: 15px;">
								</div>

								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center;">
									<label style="color: #b73333;"> Ops. </label>

								</div>
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center;">
									<label style="color: #b73333;">
										<bean:message key="text.erro500" />
									</label>
								</div>
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center;">
									...
									<label style="color: #b73333;">
										...
										<a id="linkSuporte" style="color: #b73333; font-size: 20px;">
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center;">
									...
									<label style="color: #b73333;">
										<strong><i class="fa fa-exclamation-circle"></i></strong> Evite pressionar a tecla <strong>F5</strong> de seu teclado.										
									</label>
								</div>

								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center;">
									<label>
										<a style="font-size: 20px;" href="${contextPath}/restrito/admin/desktop.src?method=abrir">
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align: center;">
									<label style="color: #b73333;">
										<a href="${contextPath}/restrito/admin/desktop.src?method=abrir" style="color: #b73333;">
											<i class="fa fa-mail-reply-all fa-fw"></i>
	...
	<script type="text/javascript">
		$(function() {
			...
			function modalSuporte() {
				var mensagem = "";
				mensagem = '<div class="row">' + '<div class="form-group col-lg-12">' + '<i class="fa fa-institution"></i>&nbsp;Desenvolvido por SRC Treinamento Tecnológico' + '</div>' + '<div class="form-group col-lg-12">' + '<i class="fa fa-phone"></i>&nbsp;(14)9.9652-7007 - Gabriel' + '</div>'
						+ '<div class="form-group col-lg-12">' + '<i class="fa fa-envelope-o"></i>&nbsp;adm@gruposrc.com.br' + '</div>' + '</div>';

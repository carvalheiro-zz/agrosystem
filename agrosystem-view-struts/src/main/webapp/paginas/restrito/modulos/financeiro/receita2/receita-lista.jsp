							...
							<table class="table table-bordered table-striped table-hover" style="font-size: 12px;">
								...
								<tbody>
									...
									<logic:iterate id="receitaCorrente" name="receitaForm" property="receitas" type="br.com.srcsoftware.modular.financeiro.receita.ReceitaDTO">
										...
										<td class="text-center" onclick="selecionar('${contextPath}/restrito/sistema/receita.src?method=selecionar&receitaFilter.id=${receitaCorrente.id}')">${receitaCorrente.contaReceber.valor}</td>

										<td class="text-center" onclick="selecionar('${contextPath}/restrito/sistema/receita.src?method=selecionar&receitaFilter.id=${receitaCorrente.id}')">${receitaCorrente.contaReceber.totalRecebido}</td>

...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: -30px; margin-bottom: -15px;">
		<h1 class="page-header cabecalho_pagina">
			...
			Pesquisar Parcelas a Pagar
			<small class="sub_cabecalho_pagina">
				<i class="fa fa-angle-double-right"></i>
				Listagem das Parcelas a Pagar
			</small>
		</h1>
	</div>
	<!-- /.col-lg-12 -->
...
<html:form styleId="form_tituloPagar_consulta" action="restrito/sistema/tituloPagar" method="post">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="panel" style="box-shadow: 0 10px 30px rgba(0, 0, 0, 0.8); border-color: #909090;">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="row">
								<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
									...
									<html:text styleClass="form-control input-sm" styleId="numeroNota" property="tituloPagarFilter.numeroNota" name="tituloPagarForm" />
								</div>
								
								<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
									<label class="text-white">Fornecedor</label>
									<html:text styleClass="form-control input-sm" styleId="nomePessoa" property="tituloPagarFilter.nomePessoa" name="tituloPagarForm" />
								</div>
								
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3">
									<label class="text-white">Descrição</label>
									<html:text styleClass="form-control input-sm" styleId="descricao" property="tituloPagarFilter.descricaoOrigem" name="tituloPagarForm" />
								</div>

								<%-- <div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-1">
									<label class="text-white">Parcela</label>
									<html:text styleClass="form-control input-sm inteiro" styleId="numero" property="tituloPagarFilter.numero" name="tituloPagarForm" />
								</div> --%>
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
									<label class="text-white">Emissão Ini.</label>
									<html:text styleClass="form-control input-sm data" styleId="dataLancamentoInicial" property="dataLancamentoInicial" name="tituloPagarForm" />
								</div>
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
									<label class="text-white">Emissão Fin.</label>
									<html:text styleClass="form-control input-sm data" styleId="dataLancamentoFinal" property="dataLancamentoFinal" name="tituloPagarForm" />
								</div>
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
									<label class="text-white">Vencimento Ini.</label>
									<html:text styleClass="form-control input-sm data" styleId="dataVencimentoInicial" property="dataVencimentoInicial" name="tituloPagarForm" />
								</div>
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
									<label class="text-white">Vencimento Fin.</label>
									<html:text styleClass="form-control input-sm data" styleId="dataVencimentoFinal" property="dataVencimentoFinal" name="tituloPagarForm" />
								</div>
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
									<label class="text-white">Pagamento Ini.</label>
									<html:text styleClass="form-control input-sm data" styleId="dataRecebimentoInicial" property="dataRecebimentoInicial" name="tituloPagarForm" />
								</div>
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
									<label class="text-white">Pagamento Fin.</label>
									<html:text styleClass="form-control input-sm data" styleId="dataRecebimentoFinal" property="dataRecebimentoFinal" name="tituloPagarForm" />
								</div>
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
									<label class="text-white">Tipo</label>
									<html:select styleClass="form-control input-sm" styleId="situacao" property="tituloPagarFilter.tipo" name="tituloPagarForm">
								...
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
									...
									<html:select styleClass="form-control input-sm" styleId="formaPagamento" property="tituloPagarFilter.formaPagamento.id" name="tituloPagarForm">
										<html:option value="">Selecione...</html:option>
										<html:optionsCollection name="tituloPagarForm" property="comboFormaPagamento(${usuarioSessaoPOJO.isADM})" label="label" value="value" />
									</html:select>
								</div>
								<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
									<label class="text-white">Situaçao</label>
									<html:select styleClass="form-control input-sm" styleId="situacao" property="tituloPagarFilter.situacao" name="tituloPagarForm">
										<html:option value="">Selecione...</html:option>
								...
								<div class="form-group col-xs-12 col-sm-2 col-md-2 col-lg-1">
									...
									<html:hidden styleId="hoje" property="hoje" name="tituloPagarForm" />
								</div>
							</div>
							<div class="row">
				...
				<!-- INICIO TABELA -->
				<logic:empty name="tituloPagarForm" property="titulosPagar">
				...
				<logic:notEmpty name="tituloPagarForm" property="titulosPagar">
					<logic:equal name="loginForm" value="true" property="acessoPermitido(${usuarioSessaoPOJO.usuario.id}.tituloPagar.filtrar)">
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-hover" style="font-size: 12px;">
									...
									<tbody>
										<!-- TABELA -->
										<logic:iterate indexId="i" id="tituloPagarCorrente" name="tituloPagarForm" property="titulosPagar" type="br.com.srcsoftware.modular.financeiro.titulo.titulopagar.TituloPagarDTO">

											<logic:equal value="Aberta" property="situacaoToString" name="tituloPagarCorrente">
												<tr title="${tituloPagarCorrente.descricaoOrigem}" style="cursor: default;">
											</logic:equal>
											<logic:equal value="Quitada" property="situacaoToString" name="tituloPagarCorrente">
												<tr style="background-color: #a6e1ff !important;cursor: default;" title="${tituloPagarCorrente.descricaoOrigem}">
											</logic:equal>
											<logic:equal value="A_Vencer" property="situacaoToString" name="tituloPagarCorrente">
												<tr style="background-color: #fff0a7 !important;cursor: default;" title="${tituloPagarCorrente.descricaoOrigem}">
											</logic:equal>
											<logic:equal value="Vencida" property="situacaoToString" name="tituloPagarCorrente">
												<tr style="background-color: #ffa7a7 !important;cursor: default;" title="${tituloPagarCorrente.descricaoOrigem}">
											</logic:equal>

											<!-- success / info / warning / danger -->
											<td class="text-center">
											<logic:equal value="true" property="parcial" name="tituloPagarCorrente">
												<i class="fa fa fa-reply fa-rotate-180" style="font-size: 14px; color: #00a9ff;"></i>
												${tituloPagarCorrente.numeroNota}
											</logic:equal>
											<logic:notEqual value="true" property="parcial" name="tituloPagarCorrente">
												${tituloPagarCorrente.numeroNota}
											</logic:notEqual>											
											
											</td>
											<td>${tituloPagarCorrente.nomePessoa}</td>
											<%-- <td class="text-center">${tituloPagarCorrente.numeroOrigem}</td> --%>
											<%-- <td>${tituloPagarCorrente.descricaoOrigem}</td> --%>
											...
											<td class="text-right" id="valor${i}">
												<%-- <logic:equal value="Fixa" property="tipo" name="tituloPagarCorrente">
													<html:text style="width:80px" styleClass="form-control input-sm dinheiro text-right" styleId="valorCampo${i}" property="titulosPagar[${i}].valor" name="tituloPagarForm" />
												</logic:equal>
												<logic:notEqual value="Fixa" property="tipo" name="tituloPagarCorrente">
													${tituloPagarCorrente.valor}
													<html:hidden styleId="valorCampo${i}" property="titulosPagar[${i}].valor" name="tituloPagarForm" />
												</logic:notEqual> --%>
											...
											<td class="text-right">
												<logic:equal value="Aberta" property="situacao" name="tituloPagarCorrente">
													<html:text style="width:80px" styleClass="form-control input-sm dinheiro text-right" styleId="valorAcrescimo${i}" property="titulosPagar[${i}].acrescimo" name="tituloPagarForm" />
												</logic:equal>
												<logic:equal value="Quitada" property="situacao" name="tituloPagarCorrente">
											...
											<td class="text-right">
												...
												<html:hidden styleId="valorFinalCampo${i}" property="titulosPagar[${i}].valorFinal" name="tituloPagarForm" />
											</td>
											<td class="text-right">
												<logic:equal value="Aberta" property="situacao" name="tituloPagarCorrente">
													<html:text style="width:85px" styleClass="form-control input-sm dinheiro text-right pago" styleId="valorPago${i}" property="titulosPagar[${i}].valorPago" name="tituloPagarForm" />
												</logic:equal>
												<logic:equal value="Quitada" property="situacao" name="tituloPagarCorrente">
											...
											<td class="text-center">
												<logic:equal value="Aberta" property="situacao" name="tituloPagarCorrente">
													<html:text style="width:85px" styleClass="form-control input-sm data text-center" styleId="dataRecebimento${i}" property="titulosPagar[${i}].dataRecebimento" name="tituloPagarForm" />
												</logic:equal>
												<logic:equal value="Quitada" property="situacao" name="tituloPagarCorrente">
											...
											<td>
												<logic:equal value="Aberta" property="situacao" name="tituloPagarCorrente">
													<html:select styleClass="form-control input-sm" styleId="formaPagamento${i}" property="titulosPagar[${i}].formaPagamento.id" name="tituloPagarForm">
														<html:option value="">Selecione...</html:option>
														<html:optionsCollection name="tituloPagarForm" property="comboFormaPagamento(${usuarioSessaoPOJO.isADM})" label="label" value="value" />
													</html:select>
												</logic:equal>
											...
											<%-- <logic:equal value="true" name="usuarioSessaoPOJO" property="isADM" scope="session">
												<td>${tituloPagarCorrente.empresa.nomeFantasia}</td>
											</logic:equal> --%> 
														...
														function() {
															...
															$('#quitar${i}').click(
																	function() {
																		...
																		var valor = $('#valorCampo${i}').val();//'${tituloPagarCorrente.valor}';
																		...
																		if ($('#formaPagamento${i}').val() == null || $('#formaPagamento${i}').val() == '') {
																			...
																			BootstrapDialog.show({
																				...
																				buttons : [{
																							label : 'Confirmar',
																							action : function(dialogRef) {
																								var theForm = $('form[name=tituloPagarForm]');
																								var params = theForm.serialize();
																								var actionURL = theForm.attr('action') + '?method=quitarTituloPagar&tituloPagarSelecionado.id=${tituloPagarCorrente.id}';
																								$.ajax({
																									type : 'POST',
																									url : actionURL,
																									data : params,
																									success : function(data, textStatus, XMLHttpRequest) {
																										...
																										if('${tituloPagarCorrente.tipo}' == 'Fixa'){			
																											...
																											BootstrapDialog.show({
																												size : BootstrapDialog.SIZE_LARGE,
																												title : 'Atenção...',
																												//message : $('<div></div>').load('${contextPath}/paginas/restrito/sistema/financeiro/titulopagar/modal/proxima-fixa-modal.jsp'),
																												message: camposModal,
																												closable : false,
																												type : BootstrapDialog.TYPE_DANGER,
																												onshown : function() {
																												...
																												buttons : [ {
																													...
																													action : function(dialogRef) { 
																														...
																														var actionURL = '${contextPath}/restrito/sistema/despesa.src?method=gerarProxima&parcelaSelecionada.id=${tituloPagarCorrente.id}&mesAnoProximaParcela='+$('#mesAnoProximaParcela').val();
																														$.ajax({
																															type : 'POST',
																															url : actionURL,
																															complete : function(XMLHttpRequest, textStatus) {
																																abrirModalProcessando();
																																executarComSubmit('form_tituloPagar_consulta', 'paginar');
																															},
																			...
																			buttons : [
																					{
																						...
																						action : function(dialogRef) {
																							...
																							var actionURL = theForm.attr('action')
																									+ '?method=estornarTituloPagar&tituloPagarSelecionado.id=${tituloPagarCorrente.id}';
																							$.ajax({
																								type : 'POST',
																								url : actionURL,
																								success : function(data, textStatus, XMLHttpRequest) {
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
								<span class="label label-danger" style="font-size: 15px;">Total a vista (${tituloPagarForm.totalVista})</span>
								<span class="label label-warning" style="font-size: 15px;">Total a parcelado (${tituloPagarForm.totalParcelado})</span>
								<span class="label label-info" style="font-size: 15px;">Total Fixo (${tituloPagarForm.totalFixo})</span>															
								<span class="label label-default" style="font-size: 15px;">Bruto (${tituloPagarForm.bruto})</span>
								<span class="label label-default" style="font-size: 15px;">Bruto + Acrés (${tituloPagarForm.brutoMaisAcrescimo})</span>
								<span class="label label-primary" style="font-size: 15px;">Pagos (${tituloPagarForm.pagos})</span>
								<span class="label label-success" style="font-size: 15px;">Abertos (${tituloPagarForm.abertos})</span>
							</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
								...
								<nav aria-label="Page navigation">
									<ul class="pagination" style="font-size: 12px;">
										<li>
											<a href="javascript://" style="cursor: default;">Encontrados: ${tituloPagarForm.paginacao.totalRegistros} </a>
										</li>
										<logic:equal name="tituloPagarForm" property="paginacao.voltarPaginacaoInativo" value="true">
										...
										<logic:equal name="tituloPagarForm" property="paginacao.voltarPaginacaoInativo" value="false">
											<li class="page-item">
												<a class="page-link" href="${contextPath}/restrito/sistema/tituloPagar.src?method=voltar&forwardDestino=tituloPagarLista" aria-label="Previous">
													<span aria-hidden="true">&laquo;</span>
													<span class="sr-only">Anterior</span>
												</a>
											</li>
										...
										<c:forEach var="i" begin="${tituloPagarForm.paginacao.paginaInicial}" end="${tituloPagarForm.paginacao.paginaFinal}" step="1" varStatus="row">
											<c:if test="${tituloPagarForm.paginacao.paginaCorrente == i}">
											...
											<a class="page-link" href="${contextPath}/restrito/sistema/tituloPagar.src?method=paginar&paginacao.paginaCorrente=${i}">${i}</a>
											</li>
										</c:forEach>

										<logic:equal name="tituloPagarForm" property="paginacao.avancarPaginacaoInativo" value="true">
											<li class="page-item disabled">
										...
										<logic:equal name="tituloPagarForm" property="paginacao.avancarPaginacaoInativo" value="false">
											<li class="page-item ">
												<a class="page-link" href="${contextPath}/restrito/sistema/tituloPagar.src?method=avancar&forwardDestino=tituloPagarLista" aria-label="Next">
													<span aria-hidden="true">&raquo;</span>
													<span class="sr-only">Próximo</span>
												</a>
											</li>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#nomePessoa").attr("placeholder", "Fornecedor a ser pesquisado");
		$("#descricao").attr("placeholder", "Descrição a ser pesquisada");
		/* EVENTOS */
		// Desliga o auto-complete da pagina
		$("#form_tituloPagar_consulta").attr("autocomplete", "off");

		$('#form_tituloPagar_consulta').on('submit', function(e) {
			abrirModalProcessando();
		});

		$('#pesquisar').click(function() {
			executar('form_tituloPagar_consulta', 'filtrar');
		});

		$('#limparPesquisa').click(function() {
			abrirModalProcessando();
			executarComSubmit('form_tituloPagar_consulta', 'limparFiltro');
		});		

				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<html:form styleId="form_despesa" action="restrito/sistema/despesa" method="post">
							...
							<%-- <html:hidden property="despesa.contaPagar.quantidadeParcelas" name="despesaForm" styleClass="avista" /> --%>

							<div class="row">
								<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
									<div class="alert alert-success" style="margin-bottom: 0px; margin-bottom: 0px; padding-top: 5px; padding-bottom: 5px;" id="alert-situacaoDespesa">
										<div class="row">
											<div class="col-xs-12 col-sm-10 col-md-12 col-lg-4">
												<div class="col-xs-12 col-sm-10 col-md-12 col-lg-7">
													<strong>Situação:</strong>
													<span id="situacaoDespesa" style="font-size: 30px;"></span>
												</div>
												<div class="col-xs-12 col-sm-10 col-md-12 col-lg-5">
													<span style="font-size: 30px; color: red;">${despesaForm.despesa.contaPagar.canceladoToString}</span>
												</div>
											</div>
											<div class="col-xs-12 col-sm-10 col-md-12 col-lg-4 text-center">
												<strong>Total R$ </strong>
												<span id="valorTotalDespesa" style="font-size: 30px;"></span>
											</div>
											<div class="col-xs-12 col-sm-10 col-md-12 col-lg-4 text-right">
												<strong>Pago + Acréscimo R$ </strong>
												<span id="valorTotalMaisJurosMultaDespesa"></span>
											</div>
										</div>
									</div>
								</div>
							</div>
							<ul class="nav nav-tabs" id="tabsDespesa">
								<li class="active">
									<a data-toggle="tab" href="#dadosDespesa">Dados da Despesa</a>
								</li>
								<li>
							...
							<div class="tab-content">
								<div id="dadosDespesa" class="tab-pane fade in active" style="margin-top: 20px;">
									<div class="row">
										<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12" id="abaDespesa">
										...
										<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-4" id="abaDespesa">
											<label>Valor</label>
									...
									<div class="row" style="margin-top: 15px;">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											...
											<%-- Descomentar cado queira permitir cancelamento -FUNCIONANDO-<logic:present property="despesa.id" name="despesaForm">
												<logic:empty name="despesaForm" property="despesa.contaPagar.canceladoToString">
													<logic:equal name="despesaForm" value="true" property="acessoPermitido(${usuarioSessaoPOJO.usuario.id}.despesa.alterar)">
								...
								<div id="dadosFinanceiros" class="tab-pane fade" style="margin-top: 20px;">
									...
									<div class="row">
										...
										<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
											<label>Emissão</label>
											<html:text styleClass="form-control input-sm data text-center " styleId="data" property="despesa.contaPagar.data" name="despesaForm" />
										</div>
										...
										<div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-2">
											<label>À vista / Parcelado / Fixa</label>
										...
										<div class="form-group col-xs-6 col-sm-6 col-md-63 col-lg-3" id="divAtiva">
	...
	$(document).ready(function() {
		...
		function gerenciarFormaPagamento(){
			...
			if (dataVencimento.getTime() != hoje.getTime() ) {
				...
				if ( $('#situacaoDespesa').text() != 'Quitada') {
				...
				BootstrapDialog.show({
					...
					buttons : [ {
						...
						action : function(dialogRef) {
							...
							$('#valorTotalDespesa').text($("#valor").val());
						...
						action : function(dialogRef) {
							...
							$('#valorTotalDespesa').text(valorOld);
		...
		$('#inserir').click(function() {
			inserirComAba('form_despesa', 'inserir');
		});

		$('#alterar').click(function() {
			alterarComAba('form_despesa', 'alterar');
		});
		...
		$('#cancelar').click(function() {
			BootstrapDialog.show({
				...
				buttons : [ {
					label : 'Confirmar',
					action : function(dialogRef) {
						executarComSubmit('form_despesa', 'cancelar');
						dialogRef.close();
					}
				}, {
					label : 'Fechar',

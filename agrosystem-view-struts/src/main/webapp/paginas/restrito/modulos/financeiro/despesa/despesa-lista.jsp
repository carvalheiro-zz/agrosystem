							...
							<table class="table table-bordered table-striped table-hover" style="font-size: 12px;">
								<thead>
									...
									<tr class="cor-sistema" style="color: white;">
										...
										<th class="text-right">Pago+Acrés.</th>
								...
								<tbody>
									...
									<logic:iterate id="despesaCorrente" name="despesaForm" property="despesas" type="br.com.srcsoftware.modular.financeiro.despesa.DespesaDTO">
										...
										<td class="text-right" onclick="selecionar('${contextPath}/restrito/sistema/despesa.src?method=selecionar&despesaFilter.id=${despesaCorrente.id}')">${despesaCorrente.contaPagar.valorUltimaParcela}</td>
										<td class="text-right" onclick="selecionar('${contextPath}/restrito/sistema/despesa.src?method=selecionar&despesaFilter.id=${despesaCorrente.id}')">${despesaCorrente.contaPagar.totalPago}</td>

		...
		<div class="row">
			...
			<logic:equal name="receitaForm" property="receita.contaReceber.tipo" value="Fixa">
				<div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">
					<label>Tipo</label>
					<html:text styleClass="form-control input-sm bloqueado" styleId="tipoPagamentoFixo" property="receita.contaReceber.tipo" name="receitaForm"/>
					<span id="helpBlock" class="help-block">Representa uma Receita Mensal.</span>
				</div>
			</logic:equal>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#modalCadastrarFormaPagamento').on('click', function() {
			var actionURL = "${contextPath}/restrito/sistema/formaPagamento.src?method=abrirModal&formaPagamento.tipo=Receita";
		...
		function calcularValorFinal() {
			...
			$.ajax({
				...
				success : function(data, textStatus, XMLHttpRequest) {
					...
					$('#valorTotalreceita').text(data.valorFinal);
				},
				error : function(XMLHttpRequest, textStatus, errorThrown) {
					alert(textStatus);
				}

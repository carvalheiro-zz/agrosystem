...
<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-3">
	<label>CPF</label>
	<html:text styleClass="form-control input-sm cpf numeroDocumentoIdentificacao" styleId="numeroDocumentoIdentificacaoFisico"
		property="fornecedor.numeroDocumentoIdentificacaoFisico" name="fornecedorForm" />
</div>
...
<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
	<label>Fixo</label>
	<html:text styleClass="form-control input-sm fixo text-center telefoneFixo" styleId="telefoneFixoFisico" property="fornecedor.telefoneFixoFisico"
		name="fornecedorForm" />
</div>
<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
	<label>Celular</label>
	<html:text styleClass="form-control input-sm cel text-center telefoneCelular" styleId="telefoneCelularFisico" property="fornecedor.telefoneCelularFisico"
		name="fornecedorForm" />
</div>
...
<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
	<label>Status</label>
	<input type="checkbox" id="ativoCheckFisico" checked data-toggle="toggle" data-on="Ativo" data-off="Inativo" data-onstyle="primary" data-offstyle="danger" data-width="100%"
		data-size="small">
...
<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<html:textarea styleClass="form-control input-sm" styleId="observacaoFisico" property="fornecedor.observacaoFisico" name="fornecedorForm" rows="3" />
</div>

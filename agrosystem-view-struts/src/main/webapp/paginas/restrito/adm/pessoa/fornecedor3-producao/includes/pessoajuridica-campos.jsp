...
<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
	<label>Fixo</label>
	<html:text styleClass="form-control input-sm cel text-center telefoneFixo" styleId="telefoneFixoJuridico" property="fornecedor.telefoneFixoJuridico" name="fornecedorForm" />
</div>
...
<%-- <div class="form-group col-xs-12 col-sm-6 col-md-3 col-lg-2">
	<label>I.M</label>
	<html:text styleClass="form-control input-sm text-center" styleId="inscricaoMunicipal" property="fornecedor.pessoaJuridica.inscricaoMunicipal" name="fornecedorForm" />
</div> --%>
...
<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<html:textarea styleClass="form-control input-sm" styleId="observacaoJuridico" property="fornecedor.observacaoJuridico" name="fornecedorForm" rows="2" />
</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		/* $('#numeroDocumentoIdentificacaoJuridico').autocomplete({
			...
			serviceUrl : '${contextPath}/restrito/sistema/fornecedor.src?method=selecionarClienteJuridicoAutoComplete',
			onSelect : function(suggestion) {				
				
				executarComSubmit('form_fornecedor', 'prePreencherDadosClienteJuridico');
			},

								...
								<tbody>
									...
									<logic:iterate id="fornecedorCorrente" name="fornecedorForm" property="fornecedores" type="br.com.srcsoftware.modular.manager.pessoa.fornecedor.FornecedorDTO">
										...
										<logic:equal name="fornecedorCorrente" value="false" property="ativo">
											...
											<td onclick="selecionar('${contextPath}/restrito/admin/fornecedor.src?method=selecionar&fornecedorFilter.id=${fornecedorCorrente.id}')">${fornecedorCorrente.natureza}</td>
											...
											<td onclick="selecionar('${contextPath}/restrito/admin/fornecedor.src?method=selecionar&fornecedorFilter.id=${fornecedorCorrente.id}')">${fornecedorCorrente.numeroDocumentoIdentificacao}</td>
											<td onclick="selecionar('${contextPath}/restrito/admin/fornecedor.src?method=selecionar&fornecedorFilter.id=${fornecedorCorrente.id}')">${fornecedorCorrente.ativoToString}</td>

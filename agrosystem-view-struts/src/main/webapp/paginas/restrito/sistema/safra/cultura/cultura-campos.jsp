		...
		<html:form styleId="form_cultura" action="restrito/sistema/cultura" method="post">
			...
			<div class="panel sombra">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="row">
								...
								<div class="form-group col-xs-12 col-sm-8 col-md-8 col-lg-8">
									<label>Nome</label>
									<html:text styleClass="form-control input-sm focoInicial" styleId="nome" property="cultura.nome" name="culturaForm" />
								</div>							
				...
				<div class="panel-footer">
					<div class="row">
						<!-- BOTOES -->
						<logic:notPresent property="cultura.id" name="culturaForm">
							<logic:equal name="culturaForm" value="true" property="acessoPermitido(${usuarioSessaoPOJO.usuario.id}.cultura.inserir)">
						...
						<logic:present property="cultura.id" name="culturaForm">
							<logic:equal name="culturaForm" value="true" property="acessoPermitido(${usuarioSessaoPOJO.usuario.id}.cultura.alterar)">
								<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" style="margin-bottom: 0px;">
						...
						<logic:equal name="culturaForm" value="true" property="acessoPermitido(${usuarioSessaoPOJO.usuario.id}.cultura.filtrar)">
							<div class="form-group col-xs-12 col-sm-3 col-md-3 col-lg-3" style="margin-bottom: 0px;">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#inserir').click(function() {
			executar('form_cultura', 'inserir');
		});

		$('#alterar').click(function() {
			executar('form_cultura', 'alterar');
		});

		$('#limpar').click(function() {
			abrirModalProcessando();
			executarComSubmit('form_cultura', 'limpar');
		});

		$('#listagem').click(function() {
			abrirModalProcessando();
			executarComSubmit('form_cultura', 'abrirListagem');
		});

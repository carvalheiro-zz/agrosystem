...
<div class="row">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin-top: -30px; margin-bottom: -15px;">
		<h1 class="page-header cabecalho_pagina">
			...
			Pesquisar Manutenção em Veículos
			<small class="sub_cabecalho_pagina">
				<i class="fa fa-angle-double-right"></i>
				Listagem das Manutenção em Veículos
			</small>
		</h1>
	</div>
	<!-- /.col-lg-12 -->
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="panel" style="box-shadow: 0 10px 30px rgba(0, 0, 0, 0.8); border-color: #909090;">
			...
			<div class="panel-heading cor-sistema">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<html:form styleId="form_manutencaoVeiculo_consulta" action="restrito/sistema/manutencaoVeiculo" method="post">
							...
							<div class="row">
								<div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
									...
									<html:text styleClass="form-control input-sm data text-center" styleId="dataInicial" property="dataInicial" name="manutencaoVeiculoForm" />
								</div>
								<div class="form-group col-xs-12 col-sm-4 col-md-3 col-lg-2">
									<label class="text-white">Data Final</label>
									<html:text styleClass="form-control input-sm data text-center" styleId="dataFinal" property="dataFinal" name="manutencaoVeiculoForm" />
								</div>

								<div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-2">
									<label class="text-white">Recibo/NF</label>
									<html:select styleClass="form-control input-sm" styleId="reciboNF" property="manutencaoVeiculo.reciboOuNotaFiscal" name="manutencaoVeiculoForm">
								...
								<div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-2" id="divNotaFiscal">
									...
									<html:text styleClass="form-control input-sm text-center" styleId="notaFiscal" property="manutencaoVeiculo.notaFiscal" name="manutencaoVeiculoForm" />
								</div>
								...
								<div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">
									...
									<html:text styleClass="form-control input-sm" styleId="veiculo" property="manutencaoVeiculo.veiculo.nomeCompleto" name="manutencaoVeiculoForm" />
									<i style="margin-top: -28px; float: right; margin-right: 8px; font-size: 25px;" class="fa fa-keyboard-o"></i>
								</div>
								<div class="form-group col-xs-12 col-sm-12 col-md-4 col-lg-4">
									<label class="text-white">Serviço</label>
									<html:text styleClass="form-control input-sm" styleId="servico" property="manutencaoVeiculo.servico.nome" name="manutencaoVeiculoForm" />
									<i style="margin-top: -28px; float: right; margin-right: 8px; font-size: 25px;" class="fa fa-keyboard-o"></i>
								</div>
			...
			<!-- INICIO TABELA -->
			<logic:empty name="manutencaoVeiculoForm" property="manutencoes">
			...
			<logic:notEmpty name="manutencaoVeiculoForm" property="manutencoes">
				<logic:equal name="loginForm" value="true" property="acessoPermitido(${usuarioSessaoPOJO.usuario.id}.manutencao.filtrar)">
					<div class="panel-body">
						<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
							<span class="label cor-sistema" style="font-size: 15px;">Total Custo: R$ ${manutencaoVeiculoForm.totalValor}</span>
						</div>
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-hover" style="font-size: 12px;">
									...
									<tbody>
										<!-- TABELA -->
										<logic:iterate id="manutencaoVeiculoCorrente" name="manutencaoVeiculoForm" property="manutencoes" type="br.com.srcsoftware.sistema.manutencao.manutencao.ManutencaoDTO">

											<tr>
												<td onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">${manutencaoVeiculoCorrente.servico.nome}</td>
												<td onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">${manutencaoVeiculoCorrente.veiculo.nomeCompleto}</td>
												<td onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">${manutencaoVeiculoCorrente.kmHorimetro}</td>
												<td class="text-center" onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">${manutencaoVeiculoCorrente.dataToString}</td>

												<logic:equal value="Recibo" name="manutencaoVeiculoCorrente" property="reciboOuNotaFiscal">
													<td class="text-center" onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">${manutencaoVeiculoCorrente.reciboOuNotaFiscal}</td>
												</logic:equal>
												<logic:equal value="Nota Fiscal" name="manutencaoVeiculoCorrente" property="reciboOuNotaFiscal">
													<td class="text-center" onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">${manutencaoVeiculoCorrente.notaFiscal}</td>
												</logic:equal>

												<td onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">${manutencaoVeiculoCorrente.finalidade}</td>
												<td onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">${manutencaoVeiculoCorrente.custo}</td>

												<td style="background-color: #e6e6e6;" onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">
													<strong>${manutencaoVeiculoCorrente.tipo}:</strong>
													${manutencaoVeiculoCorrente.nomeCompleto}
												</td>

												<td onclick="selecionar('${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=selecionar&manutencaoVeiculo.id=${manutencaoVeiculoCorrente.id}')">${manutencaoVeiculoCorrente.fornecedor.nome}</td>
												...
												<td class="text-center" style="min-width: 80px; vertical-align: middle;">
													<logic:equal name="loginForm" value="true" property="acessoPermitido(${usuarioSessaoPOJO.usuario.id}.manutencao.excluir)">
														<button type="button" id="excluir" class="btn btn-danger btn-xs fa fa-trash" style="font-size: 14px"
															onclick="excluir('${manutencaoVeiculoCorrente.data}-${manutencaoVeiculoCorrente.notaFiscal}', 'sistema/manutencaoVeiculo', ${manutencaoVeiculoCorrente.id} );"></button>
													</logic:equal>
												</td>
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
							...
							<nav aria-label="Page navigation">
								<ul class="pagination" style="font-size: 12px;">
									<li>
										<a href="javascript://" style="cursor: default;">Encontrados: ${manutencaoVeiculoForm.paginacao.totalRegistros} </a>
									</li>
									<logic:equal name="manutencaoVeiculoForm" property="paginacao.voltarPaginacaoInativo" value="true">
									...
									<logic:equal name="manutencaoVeiculoForm" property="paginacao.voltarPaginacaoInativo" value="false">
										<li class="page-item">
											<a class="page-link" href="${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=voltar&forwardDestino=manutencaoVeiculoLista" aria-label="Previous">
												<span aria-hidden="true">&laquo;</span>
												<span class="sr-only">Anterior</span>
											</a>
										</li>
									...
									<c:forEach var="i" begin="${manutencaoVeiculoForm.paginacao.paginaInicial}" end="${manutencaoVeiculoForm.paginacao.paginaFinal}" step="1" varStatus="row">
										<c:if test="${manutencaoVeiculoForm.paginacao.paginaCorrente == i}">
										...
										<a class="page-link" href="${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=paginar&paginacao.paginaCorrente=${i}">${i}</a>
										</li>
									</c:forEach>

									<logic:equal name="manutencaoVeiculoForm" property="paginacao.avancarPaginacaoInativo" value="true">
										<li class="page-item disabled">
									...
									<logic:equal name="manutencaoVeiculoForm" property="paginacao.avancarPaginacaoInativo" value="false">
										<li class="page-item ">
											<a class="page-link" href="${contextPath}/restrito/sistema/manutencaoVeiculo.src?method=avancar&forwardDestino=manutencaoVeiculoLista" aria-label="Next">
												<span aria-hidden="true">&raquo;</span>
												<span class="sr-only">Próximo</span>
											</a>
										</li>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#form_manutencaoVeiculo_consulta").prop("autocomplete", "off");
		
		$('#form_manutencaoVeiculo_consulta').on('submit', function(e){
	        abrirModalProcessando();
	    });		
		
		$('#pesquisar').on('click', function(e){
			executar('form_manutencaoVeiculo_consulta','filtrar');
		 });
	   		
		$('#limparPesquisa').on('click', function(e){
			abrirModalProcessando();
			executarComSubmit('form_manutencaoVeiculo_consulta','limparFiltro');
	    });
		
		$('#novo').on('click', function(e){
			abrirModalProcessando();
			executarComSubmit('form_manutencaoVeiculo_consulta','abrirCadastro');
	    });

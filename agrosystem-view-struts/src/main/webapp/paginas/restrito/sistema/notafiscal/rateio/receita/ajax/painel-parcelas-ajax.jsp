...
<logic:iterate indexId="i" id="parcelaCorrente" name="notaFiscalRateioReceitaForm" property="notaFiscalRateio.contaReceber.parcelas" type="br.com.srcsoftware.modular.financeiro.titulo.tituloreceber.TituloReceberDTO">

	<html:hidden styleClass="form-control input-sm dinheiro bloqueado text-right juros" styleId="juros${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].juros" name="notaFiscalRateioReceitaForm" />
		...
		<div class="row">
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
				...
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm data text-center" styleId="dataVencimento${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].dataVencimento" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm data text-center bloqueado" styleId="dataVencimento${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].dataVencimento" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
				<label>Pagamento</label>
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm data text-center" styleId="dataRecebimento${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].dataRecebimento" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm data text-center bloqueado" styleId="dataRecebimento${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].dataRecebimento" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-3 col-lg-2">
				...
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:select styleClass="form-control input-sm formaPagamento" styleId="formaPagamento${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].formaPagamento.id" name="notaFiscalRateioReceitaForm">
				...
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<%-- <html:select styleClass="form-control input-sm formaPagamento bloqueado" styleId="formaPagamento${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].formaPagamento.id" name="notaFiscalRateioReceitaForm">
					<html:option value="">Selecione...</html:option>
					...
					<html:text styleClass="form-control input-sm formaPagamento bloqueado" styleId="formaPagamento${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].formaPagamento.nomeCompleto" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
				<label>Valor</label>
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right valor valorAberta" styleId="valor${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].valor" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right bloqueado" styleId="valor${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].valor" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-1">
				<label>% Multa</label>
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm decimal text-right " styleId="percentualMulta${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].percentualMulta" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm decimal text-right bloqueado" styleId="percentualMulta${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].percentualMulta" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
			</div>
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-1">
				<label>% Juros</label>
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm decimal text-right" styleId="percentualJuros${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].percentualJuros" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm decimal text-right bloqueado" styleId="percentualJuros${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].percentualJuros" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
				<label>Total</label>
				<html:text styleClass="form-control input-sm dinheiro bloqueado text-right valorFinal${parcelaCorrente.situacao}" styleId="valorFinal${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].valorFinal" name="notaFiscalRateioReceitaForm" />
			</div>
			<%-- <div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
			<label>Juros</label>
			<html:hidden styleClass="form-control input-sm dinheiro bloqueado text-right juros" styleId="juros${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].juros" name="notaFiscalRateioReceitaForm" />
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-2 col-lg-2">
				<label>Pago</label>
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right pago" styleId="valorPago${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].valorPago" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right pago bloqueado pagoQuitada" styleId="valorPago${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].valorPago" name="notaFiscalRateioReceitaForm" />
				</logic:equal>
		...
		<logic:equal value="Cheque" property="formaPagamento.nome" name="parcelaCorrente">
			<div class="row" style="border-top: 1px solid #b9b9b9; padding-top: 5px;">
				<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-3">
					<label>Banco</label>
					<html:text styleClass="form-control input-sm" styleId="banco${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].bancoCheque" name="notaFiscalRateioReceitaForm" />
				</div>
				<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
					<label>Conta corrente</label>
					<html:text styleClass="form-control input-sm text-center" styleId="ccCheque${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].ccCheque" name="notaFiscalRateioReceitaForm" />
				</div>
				<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
					<label>Nº cheque</label>
					<html:text styleClass="form-control input-sm text-center" styleId="numeroCheque${i}" property="notaFiscalRateio.contaReceber.parcelas[${i}].numeroCheque" name="notaFiscalRateioReceitaForm" />
				</div>
			</div>
		</logic:equal>
		</div>
						...
						action : function(dialogRef) {
							...
							$.ajax({
								...
								success : function(data, textStatus, XMLHttpRequest) {
									...
									$('#tabsNotaFiscalRateioReceita a[href="#financeiro"]').tab('show');
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if ($(".situacao").length > 0) {
			$('#situacaoNotaFiscalRateioReceita').text('Quitada');
			$('#alert-situacaoNotaFiscalRateioReceita').removeClass('alert-success');
			$('#alert-situacaoNotaFiscalRateioReceita').css('background-color', 'rgba(0, 18, 230, 0.41)');// Quitada

			$(".situacao").each(function(index, element) {
				if ($(element).val() != null && $(element).val() != '') {
					if ($(element).val() == 'Aberta') {
						$('#situacaoNotaFiscalRateioReceita').text('Aberta');
						$('#alert-situacaoNotaFiscalRateioReceita').css('background-color', '');// Aberta
						$('#alert-situacaoNotaFiscalRateioReceita').addClass('alert-success');
						return false;
					}
				}
			});
		...
		if ($(".pago").length > 0) {
			$('#valorTotalMaisJurosMultaNotaFiscalRateioReceita').text('0,00');
			...
			$('#valorTotalMaisJurosMultaNotaFiscalRateioReceita').text(soma);
		} else {
			$('#valorTotalMaisJurosMultaNotaFiscalRateioReceita').text('0,00');
		}
	...
	function validadeValoresParcelas() {
		...
		// Valor DA NF
		var valorNF = '${notaFiscalRateioReceitaForm.notaFiscalRateio.contaReceber.valor}';

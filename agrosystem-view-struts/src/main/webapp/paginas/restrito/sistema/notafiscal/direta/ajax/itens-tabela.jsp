	...
	<div class="panel-heading" style="font-size: 30px; padding: 0px 15px">
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-7 text-right">
				<label>Total NF R$&nbsp;${notaFiscalVendaDiretaForm.notaFiscalVendaDireta.valorCustoTotal}</label>
			</div>
		</div>
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<div class="table-responsive" style="max-height: 523px; min-height: 523px;">
					<table class="table table-bordered table-striped table-hover" style="font-size: 11px;">
						...
						<tbody>
							<logic:iterate indexId="i" id="itemCorrente" name="notaFiscalVendaDiretaForm" property="notaFiscalVendaDireta.itens" type="br.com.srcsoftware.sistema.notafiscal.direta.item.ItemNotaFiscalVendaDiretaDTO">
								<tr style="background-color:${itemCorrente.corInformativaEntrega}">
									...
									<td class="text-right has-success">
										<html:text style="min-width: 135px;" styleClass="form-control input-sm text-right precoCusto" styleId="precoCusto${i}" property="notaFiscalVendaDireta.itens[${i}].precoCusto" name="notaFiscalVendaDiretaForm" />
									</td>
									
									<td>
										<html:text style="min-width: 135px;" styleClass="form-control text-center input-sm  quantidade" styleId="quantidade${i}" property="notaFiscalVendaDireta.itens[${i}].quantidade" name="notaFiscalVendaDiretaForm" />
									</td>
									<td class="text-center">${itemCorrente.quantidadeRestante}</td>									

									<td>${itemCorrente.produto.unidadeMedida.sigla}</td>

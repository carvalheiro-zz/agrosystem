...
<logic:iterate indexId="i" id="parcelaCorrente" name="notaFiscalRateioDespesaForm" property="notaFiscalRateio.contaPagar.parcelas" type="br.com.srcsoftware.modular.financeiro.titulo.titulopagar.TituloPagarDTO">
		...
		<div class="row">
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
				...
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm data text-center" styleId="dataVencimento${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].dataVencimento" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm data text-center bloqueado" styleId="dataVencimento${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].dataVencimento" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
				<label>Pagamento</label>
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm data text-center" styleId="dataRecebimento${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].dataRecebimento" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm data text-center bloqueado" styleId="dataRecebimento${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].dataRecebimento" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
				...
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:select styleClass="form-control input-sm formaPagamento" styleId="formaPagamento${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].formaPagamento.id" name="notaFiscalRateioDespesaForm">
				...
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<%-- <html:select styleClass="form-control input-sm formaPagamento bloqueado" styleId="formaPagamento${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].formaPagamento.id" name="notaFiscalRateioDespesaForm">
					<html:option value="">Selecione...</html:option>
					<html:optionsCollection name="notaFiscalRateioDespesaForm" property="comboFormaPagamentoAVista(${usuarioSessaoPOJO.isADM})" label="label" value="value" />
				</html:select> --%>
					<html:text styleClass="form-control input-sm formaPagamento bloqueado" styleId="formaPagamento${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].formaPagamento.nomeCompleto" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
				<label>Valor</label>
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right valorAberta" styleId="valor${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].valor" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right bloqueado" styleId="valor${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].valor" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
			...
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
				...
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right acrescimo" styleId="valorAcrescimo${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].acrescimo" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right acrescimo bloqueado" styleId="valorAcrescimo${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].acrescimo" name="notaFiscalRateioDespesaForm" />
				</logic:equal>

			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
				<label>Total</label>
				<html:text styleClass="form-control input-sm dinheiro bloqueado text-right valorFinal${parcelaCorrente.situacao}" styleId="valorFinal${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].valorFinal" name="notaFiscalRateioDespesaForm" />
			</div>
			<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
				<label>Pago</label>
				<logic:equal value="Aberta" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right pago" styleId="valorPago${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].valorPago" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
				<logic:equal value="Quitada" property="situacao" name="parcelaCorrente">
					<html:text styleClass="form-control input-sm dinheiro text-right pago bloqueado pagoQuitada" styleId="valorPago${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].valorPago" name="notaFiscalRateioDespesaForm" />
				</logic:equal>
		...
		<logic:equal value="Cheque" property="formaPagamento.nome" name="parcelaCorrente">
			<div class="row" style="border-top: 1px solid #b9b9b9; padding-top: 5px;">
				<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-3">
					<label>Banco</label>
					<html:text styleClass="form-control input-sm" styleId="banco${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].bancoCheque" name="notaFiscalRateioDespesaForm" />
				</div>
				<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
					<label>Conta corrente</label>
					<html:text styleClass="form-control input-sm text-center" styleId="ccCheque${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].ccCheque" name="notaFiscalRateioDespesaForm" />
				</div>
				<div class="form-group col-xs-12 col-sm-12 col-md-12 col-lg-2">
					<label>Nº cheque</label>
					<html:text styleClass="form-control input-sm text-center" styleId="numeroCheque${i}" property="notaFiscalRateio.contaPagar.parcelas[${i}].numeroCheque" name="notaFiscalRateioDespesaForm" />
				</div>
			</div>
		</logic:equal>
		</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#valor').val('${notaFiscalRateioDespesaForm.notaFiscalRateio.contaPagar.valor}');
							...
							action : function(dialogRef) {
								...
								$.ajax({
									...
									success : function(data, textStatus, XMLHttpRequest) {
											...
											$('#tabsNotaFiscalRateioDespesa a[href="#financeiro"]').tab('show');
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		if ($(".situacao").length > 0) {
			$('#situacaoNotaFiscalRateioDespesa').text('Quitada');
			$('#alert-situacaoNotaFiscalRateioDespesa').removeClass('alert-success');
			$('#alert-situacaoNotaFiscalRateioDespesa').css('background-color', 'rgba(0, 18, 230, 0.41)');// Quitada

			$(".situacao").each(function(index, element) {
				if ($(element).val() != null && $(element).val() != '') {
					if ($(element).val() == 'Aberta') {
						$('#situacaoNotaFiscalRateioDespesa').text('Aberta');
						$('#alert-situacaoNotaFiscalRateioDespesa').css('background-color', '');// Aberta
						$('#alert-situacaoNotaFiscalRateioDespesa').addClass('alert-success');
						return false;
					}
				}
			});
		...
		if ($(".pago").length > 0) {
			$('#valorTotalMaisAcrescimoNotaFiscalRateioDespesa').text('0,00');
			...
			$('#valorTotalMaisAcrescimoNotaFiscalRateioDespesa').text(soma);
		} else {
			$('#valorTotalMaisAcrescimoNotaFiscalRateioDespesa').text('0,00');
		}
	...
	function validadeValoresParcelas() {
		...
		// Valor da NotaFiscalRateioDespesa
		var valorNotaFiscalRateioDespesa = '${notaFiscalRateioDespesaForm.notaFiscalRateio.contaPagar.valor}';
		valorNotaFiscalRateioDespesa = parseFloat((valorNotaFiscalRateioDespesa + ".0").replace('.', '').replace(',', '.').replace('R$', ''), 2);

		var diferenca = somaValorPagoQuitada + somaValorFinalAberta;
		diferenca = diferenca.toFixed(2) - somaAcrescimo;
		diferenca = diferenca.toFixed(2) - valorNotaFiscalRateioDespesa;

		//alert('valorNotaFiscalRateioDespesa: ' +valorNotaFiscalRateioDespesa+ ' somaAcrescimo: ' + somaAcrescimo + ' somaValorPagoQuitada: ' + somaValorPagoQuitada + ' somaValorFinalAberta: ' + somaValorFinalAberta);

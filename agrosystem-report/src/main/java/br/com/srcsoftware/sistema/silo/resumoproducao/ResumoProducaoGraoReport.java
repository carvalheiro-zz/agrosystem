package br.com.srcsoftware.sistema.silo.resumoproducao;
...
public final class ResumoProducaoGraoReport extends MasterReport{
	 ...
	 */
	public ResumoProducaoGraoReport( String nomePastaOrigemRelatorios, String camposFitragem, String versaoSistema ) throws ApplicationException{
	 ...
	 * @throws IOException
	 */
	public void gerarRelatorio( HttpServletResponse response, EmpresaDTO empresa, List< InformacoesProducaoSafraPOJO > encontrados, String camposPesquisa ) throws ApplicationException, IOException {

		calcularTotais( encontrados );
		...
		byte[ ] reportByte = this.facade.gerarRelatorioPDF( "resumoproducao", encontrados, this.reportPath, this.parametros );
	...
	public void calcularTotais( List< InformacoesProducaoSafraPOJO > encontradosParaTotais ) {

		BigDecimal totalProducao = BigDecimal.ZERO;
		BigDecimal totalSacas = BigDecimal.ZERO;

		for ( InformacoesProducaoSafraPOJO corrente : encontradosParaTotais ) {

			BigDecimal producao = br.com.srcsoftware.modular.manager.utilidades.Utilidades.parseBigDecimal( corrente.getProducao() );
			totalProducao = totalProducao.add( producao );
		...
		this.parametros.put( "TOTAL_PRODUCAO", br.com.srcsoftware.modular.manager.utilidades.Utilidades.parseBigDecimal( totalProducao ) );
